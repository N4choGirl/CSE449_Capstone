...
/**
 * Main class for the application, runs the app and initializes all of the things for the JavaFX
 * 
 * @author SPAnalytics group from 2018-2019
 *
 */
public class Main extends Application {
	...
	/**
	 * Launch is a JavaFX method that is called to start the application
	 * 
	 * @param args Any args that are passed in.
	 */
