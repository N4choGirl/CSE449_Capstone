...
/**
 * Used to get a connection to the firebase database, as well as add data/get data out of it. If/when the switch to 
 * the SQL database is done this will most likely be obsolete. It may be a thing that you can repurpose this so 
 * that you can use it for a SQL model? I'm not totally sure. All comments are from Phase 1 below.
 * 
